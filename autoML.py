...
if __name__ == "__main__":
    ...
    log.info("Programado para correr cada 6 horas.")

    # Primera ejecución inmediata
    run_renewal_cycle()

    # Programar cada 6 horas (el token dura 6h, se renueva al inicio de cada ciclo)
    schedule.every(6).hours.do(run_renewal_cycle)
